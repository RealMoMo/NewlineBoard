...
import com.newline.borad.touch.ChildViewTouchListenerImpl
 ...
 * @describe
 */
class ChildViewTouchWithFlingListenerImpl(context: Context, touchEvent: FloatBarTouchEvent, view: View) :
