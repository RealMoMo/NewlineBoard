...
import kotlinx.android.synthetic.main.layout_vertical_drawbar.view.*
...
class VerticalDrawBarLayout : BaseDrawBarLayout, View.OnClickListener, View.OnLongClickListener {
    ...
    override fun inflateBarLayout() {
        LayoutInflater.from(context).inflate(R.layout.layout_vertical_drawbar, this, true)
    }
